...
namespace GbXmlDesignSuite.Modules.VentCalc.ViewModels
{
    public class VentCalcViewModel : BindableBase, IActiveAware
    {
        ...
        public VentCalcViewModel(IRegionManager regionManager,
        ...
        private void OnIsActiveChanged()
        {
            ...
            if (IsActive)
            {
                ...
                var state = _projectStateService.GetModuleState("VentCalc");
                if (state != null)
                {
            ...
            else
            {
                ...
                _projectStateService.SetModuleState("VentCalc", Projects);
            }
        }
